...
CREATE TABLE lp2008_braicesold130516 (
  ARTICULO_ID mediumint(9) NOT NULL DEFAULT '0',
  HABITACIONES varchar(4) NOT NULL DEFAULT '0',
  BANOS varchar(10) NOT NULL DEFAULT '0',
  MCONSTRUIDOS varchar(10) NOT NULL DEFAULT '0',
  ...
  LAT varchar(25) DEFAULT NULL COMMENT 'LATITUD COORD',
  LNG varchar(25) DEFAULT NULL COMMENT 'LONGITUD COORD',
  MAPA enum('S','N') NOT NULL DEFAULT 'N' COMMENT 'PERMITE MOSTRAR MAPA O NO',
  ESTATUS enum('A','I') NOT NULL DEFAULT 'A'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE lp2008_braices_old (
  ARTICULO_ID mediumint(9) NOT NULL DEFAULT '0',
  HABITACIONES varchar(4) NOT NULL DEFAULT '0',
  BANOS varchar(10) NOT NULL DEFAULT '0',
  MCONSTRUIDOS varchar(10) NOT NULL DEFAULT '0',
...
CREATE TABLE lp2008_categorias_bk (
  ID smallint(6) NOT NULL DEFAULT '0',
  CATEGORIA varchar(150) NOT NULL DEFAULT '',
  PUBLICADOS smallint(6) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='TABLA DE CATEGORIAS DE ARITUCLOS';

CREATE TABLE lp2008_categorias_bk1 (
  ID smallint(6) NOT NULL DEFAULT '0',
  CATEGORIA varchar(150) NOT NULL DEFAULT '',
  PUBLICADOS smallint(6) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='TABLA DE CATEGORIAS DE ARITUCLOS';
...
CREATE TABLE lp2008_cemarcaold (
  ID varchar(4) NOT NULL DEFAULT '',
  MARCA varchar(40) NOT NULL DEFAULT '',
  PUBLICADOS smallint(6) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='CONTIENE LA MARCA DE LOS CELULARES';

CREATE TABLE lp2008_cemarca_old231214 (
  ID tinyint(4) NOT NULL,
  MARCA varchar(40) NOT NULL DEFAULT '',
  PUBLICADOS smallint(6) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='CONTIENE LA MARCA DE LOS CELULARES';
...
CREATE TABLE lp2008_cemodeloold (
  ID varchar(5) NOT NULL DEFAULT '',
  MARCA_ID varchar(5) NOT NULL DEFAULT '0',
  MODELO varchar(50) NOT NULL DEFAULT '',
  PUBLICADOS smallint(6) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='MODELOS DE CELULARES';

CREATE TABLE lp2008_cemodelo_old231214 (
  ID smallint(5) NOT NULL,
  MARCA_ID tinyint(5) NOT NULL DEFAULT '0',
  MODELO varchar(50) NOT NULL DEFAULT '',
  PUBLICADOS smallint(6) NOT NULL DEFAULT '0'
...
CREATE TABLE lp2008_complementosold0202 (
  ARTICULO_ID int(11) NOT NULL,
  TIPOCOMP enum('CE','VE','BR') COLLATE utf8_unicode_ci NOT NULL,
  MARCA varchar(4) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  MODELO varchar(4) COLLATE utf8_unicode_ci DEFAULT '0',
  ANIO varchar(4) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N/A',
  COMBUSTIBLE varchar(5) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N/A',
  PROVINCIA varchar(4) COLLATE utf8_unicode_ci DEFAULT NULL,
  SECTOR varchar(4) COLLATE utf8_unicode_ci DEFAULT NULL,
  HABITACIONES varchar(4) COLLATE utf8_unicode_ci DEFAULT NULL,
  BANOS varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  PARQUEOS varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  MCONSTRUIDOS varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  MTERRENO varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  LAT varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'LATITUD COORD',
  LNG varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'LONGITUD COORD',
  MAPA enum('S','N') COLLATE utf8_unicode_ci DEFAULT 'N' COMMENT 'PERMITE MOSTRAR MAPA O NO',
  ESTATUS enum('A','I') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'A'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='CONTIENE INFO ADICIONAL DE CADA PUBLICACION, BR, CE, VEH';
...
CREATE TABLE lp2008_descripcionr (
  ARTICULO_ID mediumint(9) NOT NULL DEFAULT '0',
  DESCRIPCION text NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='CONTIENE LA DESCRIPCION DE LOS ARTICULOS';
...
CREATE TABLE lp2008_mensajeria_old (
  ID mediumint(9) NOT NULL,
  DE mediumint(9) NOT NULL DEFAULT '0',
  PARA mediumint(9) NOT NULL DEFAULT '0',
  NOMBRE varchar(90) NOT NULL,
...
CREATE TABLE lp2008_mensajes_old (
  ID smallint(6) NOT NULL,
  MENSAJERIA_ID mediumint(9) NOT NULL,
  FECHA datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  TIPO enum('S','E') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'E' COMMENT 'E- MSG ENTRADA, S - MSG SALIDA',
...
CREATE TABLE lp2008_modelosold080816 (
  ID smallint(6) NOT NULL,
...
CREATE TABLE lp2008_transacciones130520 (
  ...
  RENOVACIONES enum('S','N') NOT NULL DEFAULT 'N',
  USUARIO_ID mediumint(9) NOT NULL DEFAULT '0',
  1TIPO enum('CP','SR','RAM','OP1','OP2','LP','LP+','T1','T2','T3','TA','DV1','DV2','DV3','DV4','IN1','IN2','IN3','IN4','AO') CHARACTER SET latin1 DEFAULT 'CP' COMMENT 'TIPO DE POSIBLES TRASACCIONES',
  1PRODUCTO enum('LP','DEA','TIE','INM','RA','RAM','AO','CP') NOT NULL DEFAULT 'CP' COMMENT 'CAMPO TIPO TEMPORAL',
  1VALOR decimal(12,2) NOT NULL DEFAULT '0.00',
  1DESCUENTO float(5,2) NOT NULL DEFAULT '0.00',
  1ITBIS float(7,2) NOT NULL DEFAULT '0.00' COMMENT 'ALMACENA ITBIS COBRADO',
  1TASA float(4,2) NOT NULL DEFAULT '0.00',
  1CANTIDAD tinyint(4) NOT NULL DEFAULT '0',
  1BALANCE smallint(8) NOT NULL DEFAULT '0',
  1FORMAPAGO enum('TB','TP','TR','MM','LPP','TU','UR','PP','PU','CK','EF','RE','PIN','IC','PC') CHARACTER SET latin1 NOT NULL DEFAULT 'EF' COMMENT 'PC = Pines cortesia',
  1NCF varchar(25) DEFAULT NULL COMMENT 'NCF TRANSACCION',
  1TRANSACCION text NOT NULL,
  1ESTATUS enum('A','P','C') NOT NULL DEFAULT 'P',
  1FECHA datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  1PROCESADO datetime NOT NULL DEFAULT '0000-00-00 00:00:00'
) 1ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='ALMACENA LAS TRANSACCIONES TANTO PARA COMPRA DE PINES COMO P';
