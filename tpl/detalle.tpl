                ...
                <div class="right-product-column">	
                    ...
                    <div class="useful-links flex">
                        ...
                        <?php if ($_SESSION['lp_uid'] != $tplDetalle['USUARIO_ID']) { ?>
                            <div class="useful-link" role="group" >
                                <a href="javascript:;" id="btnklkmsgr" data-url="<?=$_SERVER['REQUEST_URI'];?>" data-logueado="<?=(Config::$usuLogueado) ? "S" : "N";?>" class="text-white bg-info" title=""><img src="/i/klkw.svg" alt="" width="30px"> Contacta por KLK Messenger</a>
